import { Check, Receipt, LogIn } from "lucide-react";
import Link from "next/link";
import { createClient } from "@/lib/supabase/server";
import { getOrders } from "@/lib/data/orders";
import { ORDER_STEPS } from "@/lib/mock-data";
...
export default async function OrdersPage() {
  ...
  if (!user) {
    return (
      <div className="mx-auto flex max-w-md flex-col items-center px-6 py-24 text-center">
        ...
        <h1 className="mt-5 font-display text-[22px] font-medium text-cocoa">Log in to see your orders</h1>
        <p className="mt-1.5 text-[14px] text-cocoa-soft">
          Your order history and live tracking live here once you&apos;re logged in.
        </p>
        <Link href="/login">
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 pb-16 pt-6 sm:px-8">
      ...
      {/* Live tracking for the most recent order */}
      {currentStepIndex >= 0 && (
